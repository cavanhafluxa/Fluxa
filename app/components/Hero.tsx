      ...
      <div className="container-fluxa relative z-10 grid w-full grid-cols-1 items-center gap-6 md:grid-cols-[1fr_1.15fr] md:gap-4 lg:grid-cols-[1fr_1.25fr] 2xl:grid-cols-[1.1fr_1fr] 2xl:gap-8">
        ...
        <div className="relative order-1 flex min-w-0 items-center justify-center md:order-2">
          ...
          <img
            ...
            alt=""
            className="hero-pizza-bg pointer-events-none block h-auto w-full max-w-[840px] -translate-x-0 select-none object-contain md:w-[172%] md:max-w-none md:-translate-x-[20%] lg:w-[170%] xl:w-[170%] 2xl:w-[130%] 2xl:max-w-[805px] 2xl:translate-x-0 min-[1800px]:max-w-[860px]"
            draggable={false}
            fetchPriority="high"
            loading="eager"
          />

export function FluxaFoods() {
  return (
    <section
      id="fluxa-foods"
      className="relative overflow-hidden bg-surface-warm py-20 text-center md:py-20 xl:py-24 2xl:py-28"
    >
      <div
        aria-hidden="true"
      ...
      <div className="container-fluxa relative">
        <div className="reveal-on-view mx-auto max-w-4xl">
          <h2 className="font-display text-3xl font-bold leading-[1.08] tracking-tight text-ink md:text-4xl lg:text-5xl xl:text-[3.25rem] 2xl:text-[3.5rem]">
